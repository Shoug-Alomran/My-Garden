...
PHY205 introduces major topics in electricity, magnetism, basic optics, and
laboratory practice. The course moves from electric charge, fields, flux, and
potential into capacitance, current, circuits, magnetic fields, induction, and
image formation.
...
The course covers selected Physics II topics in electricity, magnetism, and
optics. The main content includes capacitors and dielectrics, direct-current
circuits, magnetic fields, electromagnetism, induction, and optical
instruments.
...
3. Calculate electric forces, fields, and potentials for different charge
   arrangements.
...
6. Demonstrate basic experimental skills by setting up laboratory equipment
   safely, carrying out experimental procedures, and reporting results.
...
- Moodle is used for course materials, assignments, rubrics, and
  announcements.
- Physics laboratory, projector, smartboard, whiteboard, and student devices
  are listed as required facilities.
