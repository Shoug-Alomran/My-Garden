...
ENG103 develops research writing skills through paraphrasing, synthesis,
library research, source evaluation, documentation, annotated bibliography
writing, methodology/results writing, research ethics, survey-related work,
and final research writing review.
...
By the end of ENG103, students should be able to:

1. Recognize the different elements of a research paper.
2. Apply basic research skills to address a research question.
3. Demonstrate critical reading and analytical skills for research work.
4. Report research findings in written and verbal forms.
5. Act ethically in issues associated with research.
...
1. Start with research terminology, paraphrasing, synthesis, and APA.
2. Complete Assignment 1 through topic selection, introduction, annotation, and
   conclusion.
3. Use the midterm guide after reviewing research definitions and source use.
4. Study participant-oriented research, ethics, samples, and surveys.
5. Complete Assignment 2 through methodology, results, discussion, and
   conclusion.
6. Add AS3 poster/exhibition practice before final review.
