...
I approach security by studying how systems are designed, where they fail, and
how weaknesses can be identified and mitigated.
...
Studying cryptography teaches me how trust is built into systems. Studying
attack techniques teaches me where assumptions fail. Studying architecture-level
security teaches me how to design systems that are harder to compromise from
the start. Together, these build the kind of critical, analytical thinking that
penetration testing and security work demand.

This is the foundation I am building toward a career in offensive security and
security analysis.
