<div class="overview-hero">
  <span class="overview-kicker">SE201 · مواد المذاكرة</span>
  <h1>SE201 مواد المذاكرة</h1>
  <p>موارد مراجعة سريعة for diagrams, cheat sheets, summaries, and tool guidance.</p>
</div>
...
<div class="overview-steps">
  <div class="overview-step">ابدأ بملاحظات الفصول أولًا.</div>
  <div class="overview-step">فتح the UML guide when diagrams appear.</div>
  <div class="overview-step">Use the شرائح المحاضرات for the original chapter flow.</div>
  <div class="overview-step">استخدم ورقة المراجعة للتذكر السريع.</div>
  <div class="overview-step">راجع ملفات PDF للمراجعة النهائية.</div>
</div>

<div class="overview-note">
<strong>ملاحظة مذاكرة:</strong> This section is best for consolidation after you have already read the chapters.
</div>
