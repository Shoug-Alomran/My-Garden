---
title: ابدأ من هنا | حديقة شوق الرقمية
description: مسارات سريعة للطلاب والمحاضرين وأصحاب العمل داخل حديقة شوق الرقمية.
---
...
اختَر المسار المناسب لهدفك من زيارة الموقع.

## مسارات موجّهة (للزيارة الأولى)

<div class="hero-actions" markdown>
[مسار الطالب](Academics/Intro.md){ .md-button .md-button--primary }
[مسار المحاضر](career-development/Workshops/index.md){ .md-button }
[مسار صاحب العمل](career-development/Intro.md){ .md-button }
</div>
...
-   :mortar_board: **أنا طالب/ـة**
    ...
    - [عرض الخطة الأكاديمية](academic-plan-themes/academic-plan.md)
...
-   :school: **أنا محاضر/ـة**
    ...
    - [فتح إخلاء المسؤولية الأكاديمي](academic-disclaimer.md)
