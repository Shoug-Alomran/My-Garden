# Cybersecurity Crash Course (Offensive Security) — Reflection

## Workshop Overview
The **Cybersecurity Crash Course – Offensive Security**, organized by the **Automated Systems and Computing Lab (ASCL)** at **Prince Sultan University**, was a three-day intensive workshop designed to introduce participants to cybersecurity from an attacker’s perspective. The workshop emphasized the principle *“think like a hacker to defend like a professional”*, combining theoretical foundations with hands-on technical practice. :contentReference[oaicite:0]{index=0}
