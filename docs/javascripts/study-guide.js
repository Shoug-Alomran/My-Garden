...
(function () {
  ...
  function reveal() {
    ...
    function sweep() {
      var limit =
        (window.innerHeight || document.documentElement.clientHeight) * 0.92;
  ...
  function flashcards() {
    Array.prototype.forEach.call(
      document.querySelectorAll(".bdx-card"),
      function (card) {
  ...
  function figures() {
    ...
    box.innerHTML =
      '<button type="button" class="bdx-lightbox-close">Close</button><img alt="" />';
    document.body.appendChild(box);
    var img = box.querySelector("img");
    box
      .querySelector(".bdx-lightbox-close")
