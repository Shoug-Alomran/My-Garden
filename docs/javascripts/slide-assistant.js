(function () {
  ...
  var endpoint = window.SHOUG_AI_ENDPOINT || "https://ai.shoug-tech.com/v1/slide-assistant";
  var history = [];

  var style = document.createElement("style");
  style.textContent = [
    ".sg-ai-launch{position:fixed;right:22px;bottom:22px;z-index:99970;height:44px;padding:0 17px;border:1px solid #ff2a4b;background:#0a0514;color:#ff2a4b;font:800 .68rem 'JetBrains Mono',monospace;letter-spacing:.12em;text-transform:uppercase;box-shadow:0 12px 36px rgba(0,0,0,.35)}",
    ...
    ".sg-ai-panel.is-open{transform:none}.sg-ai-head{padding:18px;border-bottom:1px solid rgba(255,255,255,.1);display:flex;justify-content:space-between;gap:16px}.sg-ai-kicker{color:#ff2a4b;font:800 .58rem 'JetBrains Mono',monospace;letter-spacing:.16em;text-transform:uppercase}.sg-ai-title{margin-top:5px;font:800 .9rem 'JetBrains Mono',monospace}.sg-ai-close{color:#f8f7fb;border:1px solid rgba(255,255,255,.14);width:32px;height:32px;background:transparent;font-size:1.1rem}",
    ...
    "body.shoug-light-mode .sg-ai-panel{background:#fff;color:#16111f}.shoug-light-mode .sg-ai-msg.bot,.shoug-light-mode .sg-ai-input{background:#f5f1f8;color:#16111f}.shoug-light-mode .sg-ai-close{color:#16111f}@media(max-width:600px){.sg-ai-panel{top:0}.sg-ai-launch{right:14px;bottom:14px}}"
  ].join("");
