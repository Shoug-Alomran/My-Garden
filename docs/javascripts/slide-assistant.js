(function () {
  ...
  style.textContent = [
    ".sg-ai-launch{position:fixed;right:22px;bottom:96px;z-index:99970;height:44px;padding:0 17px;border:1px solid #ff2a4b;background:#0a0514;color:#ff2a4b;font:800 .68rem 'JetBrains Mono',monospace;letter-spacing:.12em;text-transform:uppercase;box-shadow:0 12px 36px rgba(0,0,0,.35);transition:opacity .16s ease,transform .16s ease}",
    ...
    "body.shoug-light-mode .sg-ai-panel{background:#fff;color:#16111f}.shoug-light-mode .sg-ai-msg.bot,.shoug-light-mode .sg-ai-input{background:#f5f1f8;color:#16111f}.shoug-light-mode .sg-ai-close{color:#16111f}@media(max-width:600px){.sg-ai-panel{top:0}.sg-ai-launch{right:14px;bottom:86px}}"
  ].join("");
