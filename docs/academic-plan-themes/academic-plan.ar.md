---
title: الخطة الأكاديمية
description: اختاري نمط المسار الدراسي المناسب لطريقة تعلمك وأهدافك.
---
...
> **ملخص القسم:** اختاري طريقة العرض التي تناسب أسلوبك الدراسي وامشي عليها بشكل منظم.

اختر نمط مسار التعلم الخاص بك:
...
-   ### :material-school-outline: الطريقة التقليدية
    ...
    [:octicons-arrow-right-24: ابدأ بالطريقة التقليدية](/ar/academic-plan-themes/old-school.html)

-   ### :material-road-variant: خارطة الطريق

    مسار تعلم مرئي مع المتطلبات الأساسية والمراحل الرئيسية. شاهد الصورة الكاملة وتتبع تقدمك.

    [:octicons-arrow-right-24: عرض خارطة الطريق](/ar/academic-plan-themes/roadmap.html)
...
-   ### :fontawesome-solid-layer-group: الحزم التعليمية
    ...
    [:octicons-arrow-right-24: استكشف الحزم](/ar/academic-plan-themes/stacks.html)
