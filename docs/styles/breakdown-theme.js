...
(function () {
  ...
  function apply(theme, persist) {
    ...
    if (btn) {
      btn.innerHTML =
        theme === "dark" ? SUN + tip("Light mode") : MOON + tip("Dark mode");
      btn.setAttribute(
        "aria-label",
  ...
  var SUN =
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/></svg>';
  var MOON =
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round"><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8Z"/></svg>';
  var UP =
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round"><path d="M12 19V5M5 12l7-7 7 7"/></svg>';
  var PRINT =
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round"><path d="M6 9V3h12v6M6 18H4v-6h16v6h-2M8 14h8v7H8z"/></svg>';

  function tip(t) {
    return '<span class="bd-tip">' + t + "</span>";
  }
  ...
  function build() {
    ...
    Array.prototype.forEach.call(
      ...
      function (t) {
        if (
          t.parentElement &&
          t.parentElement.classList.contains("bd-table-scroll")
        )
          return;
