...
-   ### :material-school-outline: الطريقة التقليدية
    ...
    [:octicons-arrow-right-24: ابدأ بالطريقة التقليدية](academic-plan-themes/old-school.html)

-   ### :material-road-variant: خارطة الطريق

    مسار تعلم مرئي مع المتطلبات الأساسية والمراحل الرئيسية. شاهد الصورة الكاملة وتتبع تقدمك.

    [:octicons-arrow-right-24: عرض خارطة الطريق](academic-plan-themes/roadmap.html)
...
-   ### :fontawesome-solid-layer-group: الحزم التعليمية
    ...
    [:octicons-arrow-right-24: استكشف الحزم](academic-plan-themes/stacks.html)
